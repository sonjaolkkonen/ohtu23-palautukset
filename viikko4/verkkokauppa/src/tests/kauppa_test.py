...
class TestKauppa(unittest.TestCase):
    ...
    def test_hinta_nollautuu_ostosten_valissa(self):
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("timo", "54321")

        self.pankki_mock.tilisiirto.assert_called_with("timo", ANY, "54321", ANY, 4)

        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("matti", "67890")

        self.pankki_mock.tilisiirto.assert_called_with("matti", ANY, "67890", ANY, 5)
    ...
    def test_poisto_korista_palauttaa_tuotteen_varastoon(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        ...
        self.assertEqual(self.saldot[tuote], 10)